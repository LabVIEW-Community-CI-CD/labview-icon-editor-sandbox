...
- **R‑003**: All binding statements in ADRs and `agent.yaml` **shall** use *shall*; preferences **should** use *should*; allowances **may** use *may*; vague, subjective terms (e.g., “user‑friendly”, “as appropriate”) **shall** be avoided. fileciteturn0file2

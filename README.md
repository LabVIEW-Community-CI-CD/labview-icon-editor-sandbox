...
- **Architecture & Viewpoints:** C4 views plus ISO/IEC/IEEE 42010 viewpoints are captured in [docs/architecture/README.md](docs/architecture/README.md) and [docs/architecture/viewpoints.md](docs/architecture/viewpoints.md).

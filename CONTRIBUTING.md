...
- **Steering Committee and BDFL**: The committee (including NI and community members) steers day-to-day decisions; major roadmap calls remain with NI.  
...
- **Fork and Clone**: Typically, you’ll fork the repo, clone your fork, and then pull this feature branch locally.  
- **Implement and Test**: Use LabVIEW 2021–2025 with the green-default Icon Editor to validate your changes.  
...
4. **Assignment and Branch**: Once you comment to claim it, a feature branch is created, and you can start development.
